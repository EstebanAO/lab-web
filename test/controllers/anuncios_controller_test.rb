...
class AnunciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anuncio" do
    assert_difference('Anuncio.count') do
      post anuncios_url, params: { anuncio: { descripcion: @anuncio.descripcion, fecha: @anuncio.fecha } }
    end
  ...
  test "should update anuncio" do
    patch anuncio_url(@anuncio), params: { anuncio: { descripcion: @anuncio.descripcion, fecha: @anuncio.fecha } }
