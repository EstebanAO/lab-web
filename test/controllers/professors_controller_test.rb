...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { email: @professor.email, father_last_name: @professor.father_last_name, mother_last_name: @professor.mother_last_name, name: @professor.name, office: @professor.office, resume: @professor.resume, type: @professor.type } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { email: @professor.email, father_last_name: @professor.father_last_name, mother_last_name: @professor.mother_last_name, name: @professor.name, office: @professor.office, resume: @professor.resume, type: @professor.type } }
