...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { date: @announcement.date, description: @announcement.description } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { date: @announcement.date, description: @announcement.description } }
