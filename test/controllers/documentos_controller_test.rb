...
class DocumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create documento" do
    assert_difference('Documento.count') do
      post documentos_url, params: { documento: { descripcion: @documento.descripcion, url: @documento.url } }
    end
  ...
  test "should update documento" do
    patch documento_url(@documento), params: { documento: { descripcion: @documento.descripcion, url: @documento.url } }
