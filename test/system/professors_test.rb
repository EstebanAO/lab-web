...
class ProfessorsTest < ApplicationSystemTestCase
  ...
  test "creating a Professor" do
    ...
    fill_in "Father last name", with: @professor.father_last_name
    fill_in "Mother last name", with: @professor.mother_last_name
    fill_in "Name", with: @professor.name
    fill_in "Office", with: @professor.office
    fill_in "Resume", with: @professor.resume
    fill_in "Type", with: @professor.type
